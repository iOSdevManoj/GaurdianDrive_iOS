...
#ifndef COUNTRYPICKERVIEW_SWIFT_H
#define COUNTRYPICKERVIEW_SWIFT_H
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC17CountryPickerView27CountryPickerViewController")
...
@interface CountryPickerViewController (SWIFT_EXTENSION(CountryPickerView)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end

@class UITableView;
@class NSIndexPath;
@interface CountryPickerViewController (SWIFT_EXTENSION(CountryPickerView))
...
@interface CountryPickerViewController (SWIFT_EXTENSION(CountryPickerView)) <UISearchControllerDelegate>
...
@class UISearchBar;
@interface CountryPickerViewController (SWIFT_EXTENSION(CountryPickerView)) <UISearchBarDelegate>
